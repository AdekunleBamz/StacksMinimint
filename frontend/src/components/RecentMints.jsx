...
export function RecentMints({ items = [] }) {
  ...
  return (
      <section className="recent-mints" aria-label="Recent mints" aria-describedby="recent-mints-subtitle" title="Recent wallet mint submissions" data-state="ready" data-count={String(recentMints.length)} aria-live="polite">
        <h2 className="recent-mints__title">Recent Mints</h2>
      <p className="recent-mints__subtitle" id="recent-mints-subtitle">Fresh activity from this browser appears here as soon as a wallet submission is sent.</p>
