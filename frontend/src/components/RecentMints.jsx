...
export function RecentMints({ items = [] }) {
  ...
  if (isLoading) {
    return (
      <section className="recent-mints" aria-label="Recent mints loading" title="Recent mint activity is loading">
  ...
  if (recentMints.length === 0) {
    return (
      <section className="recent-mints" aria-label="Recent mints empty state" title="No recent mints available yet">
        <h2 className="recent-mints__title">Recent Mints</h2>
