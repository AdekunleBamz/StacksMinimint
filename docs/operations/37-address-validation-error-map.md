...
Escalate recurring validation errors that affect legitimate addresses from known supported wallets.

Verification evidence: include sample addresses and matching error states for each mapped validation failure.
